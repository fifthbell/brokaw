...
export { PROGRAM_TEMPLATE_CONTRACT_VERSION, PROGRAM_TEMPLATE_KIND, liveProgramTemplateContract } from './program-template-manifest.js';
export type { ProgramTemplateContract } from './program-template-manifest.js';
