...
const meta = {
  ...
  render: (args, { loaded }) => render(completeDocument({ ...(loaded.categoryPage as CanonicalArticle), ...args }))
...
export const Current: Story = {
  render: (_args, { loaded }) => render(completeDocument(loaded.categoryPage as CanonicalArticle)),
  parameters: {
    controls: {
      disable: true
    }
