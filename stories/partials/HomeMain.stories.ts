...
import breakingNewsPrimaryHbs from '../../src/templates/partials/components/breaking-news/primary.hbs?raw';
import breakingNewsSecondaryHbs from '../../src/templates/partials/components/breaking-news/secondary.hbs?raw';
import breakingNewsLiveUpdatesColumnHbs from '../../src/templates/partials/components/breaking-news/live-updates-column.hbs?raw';
import breakingNewsCandyBarHbs from '../../src/templates/partials/components/breaking-news/candy-bar.hbs?raw';
...
Handlebars.registerPartial('components/breaking-news/primary', breakingNewsPrimaryHbs);
Handlebars.registerPartial('components/breaking-news/secondary', breakingNewsSecondaryHbs);
Handlebars.registerPartial('components/breaking-news/live-updates-column', breakingNewsLiveUpdatesColumnHbs);
Handlebars.registerPartial('components/breaking-news/candy-bar', breakingNewsCandyBarHbs);
